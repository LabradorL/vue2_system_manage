    ...
    >
      <div slot="file" slot-scope="{ file }">
        <img
          ...
          src="@/assets/images/fileTypeIcon/pdf.png"
          :alt="file.fileName"
        >
        <img
          v-else
      ...
      <i v-if="!isShowBtn" class="el-icon-plus" />
      <el-button v-if="isShowBtn" size="mini" type="primary">{{
        btnText
      }}</el-button>
    </el-upload>
...
export default {
  ...
  data() {
    return {
      ...
      fileList: [],
      errorImg: '@/assets/images/fileTypeIcon/pdf.png'
    }
  },
  computed: {
    // 是否显示提示
  ...
  methods: {
    ...
    handleRemove(file, fileList) {
      ...
      this.$emit('imgChange', this.fileList, this.listName)
    },
    // 上传成功回调
