/*
 * @Author: lixiaofeng
 * @Date: 2022-12-13 13:45:42
 * @LastEditors: lixiaofeng 1091616642@qq.com
 * @LastEditTime: 2023-02-01 17:07:20
 * @Description: 定义懒加载数据列表的指令
...
export default {
  ...
  inserted: (el, binding) => {
    ...
    // 获取懒加载处理函数 , 以及其他参数
    // loadData: 数据加载函数
    // distance: 触发函数调用的滚动距离
    // scrollBody 置顶滚动容器 , 不指定则为指令绑定元素
    // callback: (() => {}); // 自定义回调逻辑,可用于适时销毁监听事件
