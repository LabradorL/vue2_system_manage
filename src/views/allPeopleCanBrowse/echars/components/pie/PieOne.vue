<template>
  <div class="echarts-box">
    <template v-if="hasData">
      <div class="data-box">
        <div id="pieOne" ref="pieOneRef" class="echarts-content" />
...
export default {
  ...
  methods: {
    ...
    //  渲染图表
    renderingEcharts() {
      this.echartsDom = echarts.init(this.$refs.pieOneRef)
      // this.echartsDom = echarts.init(document.getElementById('pieOne')
      this.options.series[2].data = this.echarsData
