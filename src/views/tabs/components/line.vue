 ...
 * @LastEditTime: 2023-02-03 15:01:57
 * @Description:线式的页签 相同的元素只创建一次
-->
<template>
  <div class="">
    <el-tabs v-model="tabActive" class="customer-tabs" @tab-click="tabClick">
      <el-tab-pane
...
export default {
  ...
  watch: {},
  beforeCreate(){
    console.log('tabs line beforeCreate')
  },
  created() {
    this.getList()
  },
  beforeMount() {
    console.log('tabs line beforeMount')
  },
  mounted() {
    console.log('tabs line mounted')
  },
  beforeDestroy() {
    console.log('tabs line beforeDestroy')
  },
  destroyed() {
    console.log('tabs line destroyed')
  },
  // 方法
  methods: {
    // 获取列表
